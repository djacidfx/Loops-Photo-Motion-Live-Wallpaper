...
public class Texture2dProgram {
    ...
    public Texture2dProgram(ProgramType programType) {
        ...
        int i = AnonymousClass1.$SwitchMap$com$livwllpaper$loppphtodemo$controllers$OpenGL$LPMLWTexture2dProgram$ProgramType[programType.ordinal()];
        if (i == 1) {
    ...
    static  class AnonymousClass1 {
        static final  int[] $SwitchMap$com$livwllpaper$loppphtodemo$controllers$OpenGL$LPMLWTexture2dProgram$ProgramType;

        static {
            int[] iArr = new int[ProgramType.values().length];
            $SwitchMap$com$livwllpaper$loppphtodemo$controllers$OpenGL$LPMLWTexture2dProgram$ProgramType = iArr;
            try {
                iArr[ProgramType.TEXTURE_2D.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$livwllpaper$loppphtodemo$controllers$OpenGL$LPMLWTexture2dProgram$ProgramType[ProgramType.TEXTURE_EXT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$livwllpaper$loppphtodemo$controllers$OpenGL$LPMLWTexture2dProgram$ProgramType[ProgramType.TEXTURE_EXT_BW.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$livwllpaper$loppphtodemo$controllers$OpenGL$LPMLWTexture2dProgram$ProgramType[ProgramType.TEXTURE_EXT_FILT.ordinal()] = 4;
